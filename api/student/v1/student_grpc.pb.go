...
type StudentClient interface {
	CreateStudent(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResp, error)
}
...
func (c *studentClient) CreateStudent(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResp, error) {
	out := new(StudentResp)
...
func (UnimplementedStudentServer) CreateStudent(context.Context, *StudentRequest) (*StudentResp, error) {
...
func _Student_CreateStudent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServer).CreateStudent(ctx, req.(*StudentRequest))
	}
